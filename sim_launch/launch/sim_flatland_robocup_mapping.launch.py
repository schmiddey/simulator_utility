...
def generate_launch_description():
  ...
  #                                   "topic_name"    : "map",
  #                                   "use_sim_time"  : False,
  #                                   "yaml_filename"  : os.path.join(get_package_share_directory('sim_launch'), 'resources/robocup.yaml')
  #                                 }]
  #                                 )
  ...
  flatland_server_node = Node(package='flatland_server',
                              ...
                              output='screen',
                              parameters=[{
                                "world_path"    : os.path.join(get_package_share_directory('sim_launch'), 'resources/flatland_world_robocup.yaml'),
                                "update_rate"   : 200.0,
                                "step_size"     : 0.005,
                                "show_viz"      : False,
                                "viz_pub_rate"  : 30.0,
